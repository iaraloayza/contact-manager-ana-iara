        ...
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center space-x-4">
            <div class="flex-shrink-0">
                <!-- Ícone de Notificações Corrigido -->
            ...
            <div>
              <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Notificações</h1>
              <p class="text-sm text-slate-600">Acompanhe suas notificações</p>
            </div>
          </div>
          
          <div class="flex items-center space-x-4">
            <!-- Botão Voltar aos Contatos -->
            <Link
              href="/contacts"
